  ...
  return(
    ...
    <section className="booking">
      <div className="container">
        ...
        <form action="#" className="book-form1" onSubmit={this.handleSubmit}>
          <div className="input-group">
            <label htmlFor="fname" className="input-label">First Name</label>
            <input name="fname3" type="text" onChange={this.onFirst_nameChange} className="input" id="name" placeholder="Enter your First Name" required />
          </div>
          <div className="input-group">
            <label htmlFor="lname" className="input-label">Last Name</label>
            <input name="lname3" type="text" onChange={this.onLast_nameChange} className="input" id="name" placeholder="Enter your Last Name" required />
          </div>
          <div className="input-group">
            <label htmlFor="email" className="input-label">Email Address</label>
            <input name="email3" type="email" onChange={this.onEmailChange} className="input" id="email" placeholder="Enter your Email Address" required />
          </div>
          <div className="input-group">
